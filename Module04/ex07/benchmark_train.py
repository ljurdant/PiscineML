...
def run(x_train,y_train,x_test,y_test,thetas, lambda_:float, alpha = 1e-2, nb_iter = 1000):    
    #Training model
...
f = open(filename, "x")
print("loss,weight_order,prod_distance_order,time_delivery_order,lambda", file=f)
f.close()
